...
LEPT_DLL extern PIX * pixWindowedMean ( PIX *pixs, l_int32 size );
...
LEPT_DLL extern l_int32 boxGetCentroid ( BOX *box, l_int32 *px, l_int32 *py );
...
LEPT_DLL extern PIX * pixOctcubeQuantFromCmap ( PIX *pixs, PIXCMAP *cmap, l_int32 level, l_int32 metric );
LEPT_DLL extern PIX * pixOctcubeQuantFromCmapLUT ( PIX *pixs, PIXCMAP *cmap, l_int32 *cmaptab, l_uint32 *rtab, l_uint32 *gtab, l_uint32 *btab );
...
LEPT_DLL extern PIX * pixWoodfillTransform ( PIX *pixs, l_int32 halfsize, PIX *pixacc );
...
LEPT_DLL extern PIX * pixUnsharpMasking ( PIX *pix, l_int32 smooth, l_float32 fract );
LEPT_DLL extern PIX * pixUnsharpMaskingColor ( PIX *pixs, l_int32 smooth, l_float32 fract );
LEPT_DLL extern PIX * pixUnsharpMaskingGray ( PIX *pixs, l_int32 smooth, l_float32 fract );
...
LEPT_DLL extern FPIX * pixConvertToFPix ( PIX *pixs );
...
LEPT_DLL extern PIX * pixGenerateMaskByValue ( PIX *pixs, l_int32 val );
...
LEPT_DLL extern PIX * pixGrayQuantizeFromHisto ( PIX *pixd, PIX *pixs, PIX *pixm, l_float32 minfract, l_int32 maxsize );
...
LEPT_DLL extern PTA * searchBinaryMaze ( PIX *pixs, l_int32 xi, l_int32 yi, l_int32 xf, l_int32 yf, PIX **ppixd );
LEPT_DLL extern PTA * searchGrayMaze ( PIX *pixs, l_int32 xi, l_int32 yi, l_int32 xf, l_int32 yf, PIX **ppixd );
...
LEPT_DLL extern char * parseForProtos ( const char *filein );
...
LEPT_DLL extern l_int32 pixThresholdPixels ( PIX *pix, l_int32 thresh, l_int32 *pabove, l_int32 *tab8 );
...
LEPT_DLL extern PIX * pixaDisplayTiledInRows ( PIXA *pixa, l_int32 maxwidth, l_int32 background, l_int32 spacing );
...
LEPT_DLL extern l_int32 convertTiffG4ToPS ( const char *filein, const char *fileout, const char *operation, l_int32 x, l_int32 y, l_int32 res, l_float32 scale, l_int32 pageno, l_int32 mask, l_int32 endpage );
LEPT_DLL extern l_int32 convertTiffG4ToPSString ( const char *filein, char **poutstr, l_int32 *pnbytes, l_int32 x, l_int32 y, l_int32 res, l_float32 scale, l_int32 pageno, l_int32 mask, l_int32 endpage );
...
LEPT_DLL extern void ptraDestroy ( L_PTRA **ppa, l_int32 freeflag );
...
LEPT_DLL extern void ptraaDestroy ( L_PTRAA **ppaa, l_int32 freeflag );
...
LEPT_DLL extern l_int32 findFileFormat ( FILE *fp );
LEPT_DLL extern l_int32 findFileFormatBuffer ( const l_uint8 *buf );
...
LEPT_DLL extern PIX * pixScaleLI ( PIX *pix, l_float32 scalex, l_float32 scaley );
...
LEPT_DLL extern l_int32 findTiffCompression ( FILE *fp, l_int32 *pcomp );
...
LEPT_DLL extern void returnErrorVoid ( const char *msg, const char *procname );
