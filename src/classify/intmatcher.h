...
class IntegerMatcher {
 public:
  ...
  int FindGoodProtos(INT_CLASS ClassTemplate, BIT_VECTOR ProtoMask,
                     BIT_VECTOR ConfigMask, uint16_t BlobLength,
                     int16_t NumFeatures, INT_FEATURE_ARRAY Features,
...
----------------------------------------------------------------------------**/
void IMDebugConfiguration(INT_FEATURE FeatureNum, uint16_t ActualProtoNum,
                          uint8_t Evidence, BIT_VECTOR ConfigMask,
                          uint32_t ConfigWord);

void IMDebugConfigurationSum(INT_FEATURE FeatureNum, uint8_t* FeatureEvidence,
                             int32_t ConfigCount);
