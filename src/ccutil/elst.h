...
#ifndef NDEBUG
    if (!list) NO_LIST.error("ELIST_ITERATOR::data", ABORT, nullptr);
    if (!current) NULL_DATA.error("ELIST_ITERATOR::data", ABORT, nullptr);
#endif
    return current;
  }
...
#ifndef NDEBUG
    if (!list) NO_LIST.error("ELIST_ITERATOR::empty", ABORT, nullptr);
#endif
    return list->empty();
  }
...
#ifndef NDEBUG
  if (!list) NO_LIST.error("ELIST_ITERATOR::add_list_after", ABORT, nullptr);
  if (!list_to_add)
...
#ifndef NDEBUG
  if (!list) NO_LIST.error("ELIST_ITERATOR::add_list_before", ABORT, nullptr);
  if (!list_to_add)
...
#ifndef NDEBUG
  if (!list) NO_LIST.error("ELIST_ITERATOR::extract", ABORT, nullptr);
...
#ifndef NDEBUG
  if (!list) NO_LIST.error("ELIST_ITERATOR::move_to_first", ABORT, nullptr);
#endif
...
#ifndef NDEBUG
  if (!list) NO_LIST.error("ELIST_ITERATOR::mark_cycle_pt", ABORT, nullptr);
#endif
...
#ifndef NDEBUG
  if (!list) NO_LIST.error("ELIST_ITERATOR::at_first", ABORT, nullptr);
#endif
...
#ifndef NDEBUG
  if (!list) NO_LIST.error("ELIST_ITERATOR::at_last", ABORT, nullptr);
#endif
...
#ifndef NDEBUG
  if (!list) NO_LIST.error("ELIST_ITERATOR::cycled_list", ABORT, nullptr);
#endif
...
#ifndef NDEBUG
  if (!list) NO_LIST.error("ELIST_ITERATOR::length", ABORT, nullptr);
#endif
...
inline void ELIST_ITERATOR::sort(  // sort elements
    int comparator(                // comparison routine
        const void*, const void*)) {
#ifndef NDEBUG
  if (!list) NO_LIST.error("ELIST_ITERATOR::sort", ABORT, nullptr);
#endif
...
inline void ELIST_ITERATOR::add_to_end(  // element to add
    ELIST_LINK* new_element) {
#ifndef NDEBUG
  if (!list) NO_LIST.error("ELIST_ITERATOR::add_to_end", ABORT, nullptr);
  if (!new_element)
