...
#ifndef NDEBUG
    if (!list) NO_LIST.error("CLIST_ITERATOR::data", ABORT, nullptr);
    if (!current) NULL_DATA.error("CLIST_ITERATOR::data", ABORT, nullptr);
#endif
    return current->data;
  }
...
#ifndef NDEBUG
    if (!list) NO_LIST.error("CLIST_ITERATOR::empty", ABORT, nullptr);
#endif
    return list->empty();
  }
...
#ifndef NDEBUG
  if (!list) NO_LIST.error("CLIST_ITERATOR::add_list_after", ABORT, nullptr);
  if (!list_to_add)
...
#ifndef NDEBUG
  if (!list) NO_LIST.error("CLIST_ITERATOR::add_list_before", ABORT, nullptr);
  if (!list_to_add)
...
#ifndef NDEBUG
  if (!list) NO_LIST.error("CLIST_ITERATOR::extract", ABORT, nullptr);
...
#ifndef NDEBUG
  if (!list) NO_LIST.error("CLIST_ITERATOR::move_to_first", ABORT, nullptr);
#endif
...
#ifndef NDEBUG
  if (!list) NO_LIST.error("CLIST_ITERATOR::mark_cycle_pt", ABORT, nullptr);
#endif
...
#ifndef NDEBUG
  if (!list) NO_LIST.error("CLIST_ITERATOR::at_first", ABORT, nullptr);
#endif
...
#ifndef NDEBUG
  if (!list) NO_LIST.error("CLIST_ITERATOR::at_last", ABORT, nullptr);
#endif
...
#ifndef NDEBUG
  if (!list) NO_LIST.error("CLIST_ITERATOR::cycled_list", ABORT, nullptr);
#endif
...
#ifndef NDEBUG
  if (!list) NO_LIST.error("CLIST_ITERATOR::length", ABORT, nullptr);
#endif
...
inline void CLIST_ITERATOR::sort(  // sort elements
    int comparator(                // comparison routine
        const void*, const void*)) {
#ifndef NDEBUG
  if (!list) NO_LIST.error("CLIST_ITERATOR::sort", ABORT, nullptr);
#endif
...
#ifndef NDEBUG
  if (!list) NO_LIST.error("CLIST_ITERATOR::add_to_end", ABORT, nullptr);
  if (!new_data)
