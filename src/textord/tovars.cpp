...
EXTERN BOOL_VAR(textord_blocksall_prop, FALSE, "Moan about fixed pitch blocks");
...
EXTERN double_VAR(textord_wordstats_smooth_factor, 0.05, "Smoothing gap stats");
EXTERN double_VAR(textord_width_smooth_factor, 0.10, "Smoothing width stats");
...
EXTERN double_VAR(textord_words_default_minspace, 0.6, "Fraction of xheight");
EXTERN double_VAR(textord_words_min_minspace, 0.3, "Fraction of xheight");
EXTERN double_VAR(textord_words_default_nonspace, 0.2, "Fraction of xheight");
...
EXTERN double_VAR(textord_words_def_prop, 0.090, "Threshold for definite prop");
EXTERN INT_VAR(textord_words_veto_power, 5, "Rows required to outvote a veto");
...
EXTERN double_VAR(textord_spacesize_ratiofp, 2.8, "Min ratio space/nonspace");
EXTERN double_VAR(textord_spacesize_ratioprop, 2.0, "Min ratio space/nonspace");
