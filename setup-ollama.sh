...
echo ""
echo "To connect to GitHub Actions for automated PR reviews:"
echo "  1. Expose this server (e.g., via ngrok: ngrok http ${PORT})"
echo "  2. Add the public URL as a GitHub repo secret:"
echo "     gh secret set LLM_SERVER_URL --body 'https://your-url.ngrok.io'"
echo "  3. The .github/workflows/llm-review.yml workflow will use it automatically."
