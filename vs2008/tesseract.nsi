...
;Descriptions
  ...
  LangString DESC_SecCS    ${LANG_SPANISH} "Añadir accesos directos al menú Inicio."
  ...
  LangString DESC_SecCS    ${LANG_SPANISHINTERNATIONAL} "Añadir accesos directos al menú Inicio."
